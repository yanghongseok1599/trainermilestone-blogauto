...
// 검색 의도별 첫 문단 템플릿 (모두 센터 대표자/관계자 시점)
const INTENT_OPENINGS: Record<SearchIntent, string[]> = {
  information: [
    '저희 {businessName}에서 {keyword}에 대해 자세히 안내해 드리겠습니다.',
    '{keyword} 관련해서 많이 문의해 주시는 내용을 정리했습니다.',
    '저희 센터에서 직접 경험한 {keyword} 핵심 정보를 알려드리겠습니다.',
    '처음 시작하시는 분들을 위해 저희 트레이너들이 정리한 가이드입니다.',
  ],
  transaction: [
    '저희 {businessName}의 가격과 혜택을 상세히 안내해 드리겠습니다.',
    '저희 센터에서 현재 진행 중인 특별 이벤트를 소개합니다.',
    '{keyword} 등록을 고민 중이시라면, 저희 센터의 가격을 먼저 확인해 보세요.',
    '저희 {businessName}만의 특별 혜택을 정리해 드립니다.',
  ],
  navigation: [
    '저희 {businessName} 찾아오시는 방법과 주차 안내입니다.',
    '처음 방문하시는 분들을 위해 저희 센터 오시는 길을 상세히 안내해 드립니다.',
    '저희 {businessName}까지 가장 편하게 오시는 방법을 알려드리겠습니다.',
    '대중교통, 자차 이용 시 저희 센터 찾아오시는 방법입니다.',
  ],
  location: [
    '안녕하세요, {businessName}입니다. 저희 센터를 소개해 드리겠습니다.',
    '{keyword}를 찾고 계신다면, 저희 센터가 어떤 곳인지 알려드리겠습니다.',
    '저희 {businessName}의 시설과 프로그램을 상세히 안내해 드립니다.',
    '저희 센터만의 특별한 점을 소개해 드리겠습니다.',
  ],
};
